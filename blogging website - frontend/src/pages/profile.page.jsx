...
const ProfilePage = () =>{
    ...
    const getBlogs = ({page = 1, user_id }) =>{
        ...
        axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/search-blogs",{   author:user_id, 
            page
        })
        .then(async({ data })=>{
        ...
        <AnimationWrapper>
            {
                loading ? <Loader/> : 
                    profile_username.length ?
                        <section className="h-cover md:flex md:flex-row-reverse gap-5 min-[1100px]:gap-12">
