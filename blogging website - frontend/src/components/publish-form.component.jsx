...
const PublishForm = () => {
    ...
    return (
        <AnimationWrapper>
            <section className="w-sccreen min-h-scree grid items-center lg:grid-cols-2 py-16 lg:gap-4">
                <Toaster />

                <Button
                    className="w-12 h-12 absolute right-[5vw] z-10 top-[5%] lg:top-[5%]"
                    onClick={handleCloseEvent}
                >
                    <i className="fi fi-br-cross !important"
                        style={{ color: 'black' }}
                    ></i>
                </Button>
                ...
                <div className="max-w-[550px] center">
                    ...
                    <p className="font-gelsio line-clamp-2 text-xl leading-7 mt-4">{des}</p>
                </div>
                ...
                <div className="border-grey lg:border:1 lg:pl:8">
                    ...
                    <p className="mt-1 text-dark-grey text-sm text-right">{characterLimit - des.length} charaters left</p>
