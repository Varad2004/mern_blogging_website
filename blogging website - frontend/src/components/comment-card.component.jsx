...
const CommentCard = ({ index, leftVal, commentData }) => {
    ...
    const getParentIndex = () => {
        ...
        try {
            while (commentsArr[startingPoint].children >= commentData.childrenLevel) {
                startingPoint--;
            }
        } catch {
    ...
    const hideReplies = () => {
        ...
        setReplying(false); // Ensuring that the reply textarea is hidden
    }
    ...
    const LoadMoreRepliesButton = () =>{
        ...
        console.log(index)
        console.log(commentsArr[parentIndex])
            ...
            <div className="my-5 p-6 rounded-md border border-grey">
                ...
                <div className="flex gap-5 items-center mt-5">
                    {commentData.isReplyLoaded ?
                        <button className="text-dark-grey p02 px-3 hover:bg-grey/30 rounded-md flex items-center gap-2" onClick={hideReplies}>
                            <i className="fi fi-rr-comment-dots"></i>Hide Reply
                        </button>
                        :
                        <button className="text-dark-grey p02 px-3 hover:bg-grey/30 rounded-md flex items-center gap-2" onClick={loadReplies}>
